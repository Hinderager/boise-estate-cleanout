...
const faqData = [
  { question: 'How much does estate cleanout cost?', answer: 'Cost depends on property size, the amount and type of belongings, accessibility, timeframe, and whether most items can be donated vs. landfilled. Single-room cleanouts are the easiest end of the range, while full homes with basements and garages are the most involved. According to NAPO statistics, the average American home contains 300,000+ items. We have completed 1,200+ estate cleanouts in the Treasure Valley and provide free quotes.' },
