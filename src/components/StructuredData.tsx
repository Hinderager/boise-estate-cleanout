...
const SITE_NAME = 'Boise Estate Cleanout'
const SITE_URL = 'https://boise-estate-cleanout.com'
const SITE_PHONE = '+1-208-943-5231'
const SERVICE_NAME = 'Estate Cleanout Services'
    ...
    image: [
      {
        ...
        name: 'Estate Cleanout Services in the Treasure Valley',
        caption: 'Boise Estate Cleanout crew at work in Boise, Idaho',
        contentLocation: {
          '@type': 'Place',
          name: 'Boise, Idaho',
          geo: { '@type': 'GeoCoordinates', latitude: 43.5721, longitude: -116.1447 },
        },
      },
    ],
    aggregateRating: {
